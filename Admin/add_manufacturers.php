<?php
	...
	$nameErr = $usernameErr = $phoneErr = $emailErr = $passwordErr = "";
	...
	if(isset($_POST['submit'])) {  
	 if($nameErr == "" && $usernameErr == "" && $phoneErr == "" && $emailErr == "" && $passwordErr == "") {
	   $sql="INSERT INTO manufacturer (man_name,man_email,man_phone,username,password) Values('$name','$email','$phone','$username','$password')";
	   $sql_query=mysqli_query($con,$sql);
	   if($sql_query==TRUE){
		 header("Location: add_manufacturers.php?success=Manufacturer has been added successfully");
					...
					<div class="dropdown d-inline-block">
						...
						<div class="dropdown-menu dropdown-menu-end">
							<!-- item--><a class="dropdown-item" href="#"><i
									...
									class="align-middle">View Profile</span></a> <a class="dropdown-item"
								href="logout.php">
			...
			<div data-simplebar class="sidebar-menu-scroll">
				...
				<div id="sidebar-menu">
					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
							<a href="index.html" class="waves-effect"> <i
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"><i
									class="fas fa-users fa-3x"></i><span>Retailers</span> </a>
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"> <i
									class=" fas fa-usersfa-3x"></i> <span>Manufacturers</span> </a>
							<ul class="sub-menu" aria-expanded="false">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"><i
									class="fas fa-users fa-3x"></i> <span>Distributors</span> </a>
							<ul class="sub-menu" aria-expanded="false">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"> <i
									class="fa-brands fa-product-hunt fa-3x"></i></i> <span>wholesalers</span> </a>
							<ul class="sub-menu" aria-expanded="false">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"><i
									class="fas fa-users fa-3x"></i> <span>Customers</span> </a>
							<ul class="sub-menu" aria-expanded="false">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"><i
									class="fa-brands fa-product-hunt fa-3x"></i></i> <span>Products</span> </a>
							<ul class="sub-menu" aria-expanded="false">
		...
		<div class="main-content">
			<div class="page-content">
              ...
              <?php } ?>
										...
										<div class="input-box"> <input type="text" class="form-control"
												id="manufacturer:username" name="name" placeholder="name"
												required /><span class="error_message">
												<?php echo $nameErr; ?>
											</span>

											<div class="mb-3">

												<div class="label-block"> <label for="manufacturer:email">Email</label>
												</div>
												<div class="input-box"> <input type="text" class="form-control"
														id="manufacturer:email" name="email"
														placeholder="Email" required /> </div> <span
													class="error_message">
													<?php echo $emailErr; ?>
												</span>
											...
											<div class="mb-3">
												...
												<div>
													<input data-parsley-type="number" type="text" class="form-control"
														id="manufacturer:phone" name="phone"
														placeholder="Phone" /> <span class="error_message">
														<?php echo $phoneErr; ?>
													</span>
												</div>
											</div>
											<div class="label-block"> <label for="manufacturer:name">username</label>
											</div>
											<div class="input-box"><input type="text" class="form-control"
													id="manufacturer:username" name="username"
													placeholder="Username" required /> </div> <span
												class="error_message">
												<?php echo $usernameErr; ?>
											</span>
										</div>
										<div class="label-block"> <label for="manufacturer:name">password</label> </div>

										<div class="input-box"> <input type="password" class="form-control"
												id="manufacturer:password" name="password"
												placeholder="Password" required /> </div> <span class="error_message">
