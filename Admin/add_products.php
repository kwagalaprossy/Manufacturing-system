		...
		<div class="main-content">
			<div class="page-content">
				...
				<div>
					...
					<input type="radio" name="rdbStock" value="1">  <span style="padding: 0 3px"></span> Enable
					<input type="radio" name="rdbStock" value="2"> <span style="padding: 0 3px"></span></span> Disable
				</div>
				<div>
					<div class="label-block"> <label for="product:description">Description</label> </div>
					<div class="input-box"> <textarea type="text" id="product:description" name="txtProductDescription" placeholder="Description" cols="78" rows="4"><?php echo $descriptionHolder; ?></textarea> </div>
				</div>
				<div>
