                        ...
                        <div class="col-lg-12">
							...
							<table class="table table-centered datatable dt-responsive nowrap table-card-list"
								...
								<tr>
                                    ...
                                    <td> <?php echo $row_selectManufacturer['man_phone']; ?> </td>
									<!-- <td> <?php// echo $row_selectManufacturer['address']; ?> </td> -->
									<td> <a href="edit_manufacturer.php?id=<?php echo $row_selectManufacturer['man_id']; ?>"><img src="../images/edit.png" alt="edit" /></a> 
                                </td>
								</tr>
								<?php $i++; } ?>
							</table>
