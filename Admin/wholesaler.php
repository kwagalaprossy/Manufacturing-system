<?php
	...
	if(isset($_SESSION['admin_login'])) {
		if($_SESSION['admin_login'] == true) {
			$query_selectwholesaler = "SELECT * FROM wholesaler";
			$result_selectwholesaler = mysqli_query($con,$query_selectwholesaler);
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				if(isset($_POST['chkId'])) {
					$chkId = $_POST['chkId'];
					foreach($chkId as $id) {
						$query_deletewholesaler = "DELETE FROM wholesaler WHERE who_id='$id'";
						$result = mysqli_query($con,$query_deletewholesaler);
					}
					if(!$result) {
						echo "<script> alert(\"You can not delete the wholesaler assigned on Invoice\"); </script>";
						header('Refresh:0');
					}
					else {
...
<body>
	...
	<div id="layout-wrapper">
			...
			<div data-simplebar class="sidebar-menu-scroll" >
				...
				<div id="sidebar-menu" >
					...
					<ul class="metismenu list-unstyled" id="side-menu">
						...
						<li>
							<a href="javascript: void(0);" class="has-arrow waves-effect"><i class="fas fa-users fa-3x"></i> <span>wholesalers</span> </a>
							<ul class="sub-menu" aria-expanded="false">
								<li><a href="add_wholesalers.php">Add wholesalers</a></li>
								<li><a href="wholesalers.php">View wholesalers</a></li>
						...
						<li>
							...
							<ul class="sub-menu" aria-expanded="false">
								<li><a href="add_products.php">Add wholesalers</a></li>
								<li><a href="products.php">View wholesalers</a></li>
		...
		<div class="main-content">
			...
			<?php $i=1; while($row_selectwholesaler = mysqli_fetch_array($result_selectwholesaler)) { ?>
			<tr>
				<td> <input type="checkbox" name="chkId[]" value="<?php echo $row_selectwholesaler['who_id']; ?>" /> </td>
				<td> <?php echo $i; ?> </td>
				<td> <?php echo $row_selectwholesaler['who_name']; ?> </td>
				<td> <?php echo $row_selectwholesaler['who_email']; ?> </td>
				<td> <?php echo $row_selectwholesaler['who_phone']; ?> </td>
				<td> <?php echo $row_selectwholesaler['who_address']; ?> </td>
				<td> <a href="edit_wholesaler.php?id=<?php echo $row_selectwholesaler['who_id']; ?>"><img src="../images/edit.png" alt="edit" /></a> </td>
			</tr>
			<?php $i++; } ?>
		</table>
