<?php
	...
	if(isset($_SESSION['customer_login'])) {
		...
		$id = $_SESSION['cus_id'];
		$query_selectRetailer = "SELECT * FROM customer detils WHERE cus_id='$id'";
		...
		if($_SERVER['REQUEST_METHOD'] == "POST") {
			...
			if($phone != null) {
					$query_updateRetailer = "UPDATE retailer SET phone='$phone',email='$email',address='$address' WHERE cus_id='$id'";
